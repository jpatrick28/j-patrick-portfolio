...
},
{
  id: 12,
  title: 'Veyra Medical',
  category: 'Healthcare and Appointment Booking Website',
  description:
    'A responsive private healthcare website featuring service selection, specialist filtering, doctor profiles, clinic locations, appointment planning, persistent booking details and a working patient inquiry form.',
  highlights: [
    'Designed a calm, trust-focused healthcare experience',
    'Built service, clinic, date, time and consultation-type selection',
    'Created a searchable and filterable specialist directory',
    'Added detailed doctor quick-view modals',
    'Built persistent appointment preferences using local storage',
    'Created preventive health and diagnostic service pathways',
    'Integrated a working Web3Forms appointment request',
    'Added clear privacy, insurance and emergency guidance',
    'Configured SEO metadata and Cloudflare Pages deployment',
  ],
  technologies: [
    'React',
  ...
  status: 'Live',
  featured: true,
  liveUrl: 'https://veyra-medical.pages.dev/',
  repositoryUrl: 'https://github.com/jpatrick28/veyra-medical',
},
{
  id: 13,
  title: 'Northline Journal',
  category: 'Editorial Publication and Reading Experience',
  description:
    'A responsive architecture and culture publication featuring editorial storytelling, searchable archives, article reading controls, category filtering, saved stories and a working newsletter form.',
  highlights: [
    'Designed a distinctly editorial interface with strict grid and border systems',
    'Built a full-screen article reader with reading-progress tracking',
    'Added adjustable typography and dark reading mode',
    'Created searchable story discovery across titles, authors and categories',
    'Built category-based archive filtering with list and grid views',
    'Added persistent saved stories using local storage',
    'Created a personal reading-list drawer',
    'Integrated a working Web3Forms newsletter signup',
    'Configured SEO metadata and Cloudflare Pages deployment',
  ],
  technologies: [
